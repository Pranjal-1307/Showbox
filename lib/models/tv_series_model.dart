...
class TvsSeriesModel {
  ...
  factory TvsSeriesModel.fromRawJson(String str) => TvsSeriesModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TvsSeriesModel.fromJson(Map<String, dynamic> json) => TvsSeriesModel(
    page: json["page"],
